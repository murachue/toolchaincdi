...
RUN git clone --depth=1 -b binutils-2_35 https://github.com/murachue/binutils-gdb binutils-src && \
  ...
  git clone --depth=1 -b cdi https://github.com/murachue/psximager psximager && \
  git clone --depth=1 -b main https://github.com/murachue/elf2mod elf2mod && \
